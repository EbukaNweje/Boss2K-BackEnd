        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h4 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">You have successfully logged in to,<br/> <span style=" font-weight: 500; color:#EABD4E; margin-top:-10px; font-size: 20px;">Coinstarpro Bitminers/span></h4>
...
html: `
 <p>
          ${UserEmail.fullName} <br>
            ${UserEmail.email}  <br>
      Just Login now on your Platfrom 
 </p>
  `,
}
